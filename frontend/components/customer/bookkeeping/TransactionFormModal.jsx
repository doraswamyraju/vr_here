        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex justify-center items-center p-4 animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl overflow-y-auto max-h-[90vh] flex flex-col p-6 animate-in zoom-in-95 duration-300">
                ...
                <form onSubmit={onSubmit} className="space-y-6 flex-1 text-xs">
                    {isVoucher ? (
                        /* Simplified Cash/Bank Voucher Form for General Income & Expense */
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-200">
                                <div className="space-y-1">
                                    <label className="font-bold text-slate-600">Particulars / Category *</label>
                                    <input 
                                        type="text" 
                                        value={partyName} 
                                        onChange={e => setPartyName(e.target.value)} 
                                        placeholder="e.g. Rent, Salary, Internet, Interest"
                                        list="voucher-categories"
                                    ...
                                    <datalist id="voucher-categories">
                                        ...
                                        <option value="Internet Expenses" />
                                        <option value="Tea & Snacks" />
                                        <option value="Consultancy Fee Income" />
                                        <option value="Bank Interest Income" />
                                    </datalist>
                                </div>
                                <div className="space-y-1">
                                    <label className="font-bold text-slate-600">Total Voucher Amount (₹) *</label>
                                    <input 
                                        type="number" 
                                        value={items[0]?.rate || ''} 
                                        onChange={e => onItemChange(0, 'rate', parseFloat(e.target.value) || 0)} 
                                        placeholder="0.00"
                                        className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-800 focus:outline-none font-bold text-indigo-600"
                                        required 
                                    />
                                </div>
                                <div className="space-y-1">
                                    <label className="font-bold text-slate-600">Voucher / Ref No</label>
                                    <input 
                                        type="text" 
                                        value={docNumber} 
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1">
                                    <label className="font-bold text-slate-600">Payment Type / Mode</label>
                                    <select 
                                        value={paymentType} 
                        ...
                        /* Standard Vyapar Itemized Sales Invoice / Purchase Bill Form */
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-slate-100">
                        ...
                        <div className={`space-y-1 ${isVoucher ? 'md:col-span-3' : 'md:col-span-2'}`}>
