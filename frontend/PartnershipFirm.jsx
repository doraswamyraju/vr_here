...
const RELATED_SERVICES = [
  {
    ...
    price: "₹7,899",
    desc: "Upgrade to limited liability protection and MCA recognized corporate status.",
    link: "/llp-registration"
  },
  {
    title: "Sole Proprietorship",
    price: "₹1,499",
    desc: "Single owner trade license with Udyam MSME and instant current account resolution.",
    link: "/proprietorship-setup"
  },
  {
    title: "Private Limited Company",
    price: "₹6,499",
    desc: "The most credible corporate structure for venture-backed and high growth businesses.",
    link: "/pvt-ltd-registration"
  },
  {
    title: "GST Registration & Filing",
    price: "₹2,569",
    desc: "Complete GST registration, monthly return filing, and CA compliance support.",
    ...
    launchRazorpayCheckout({
      ...
      onSuccess: async (data) => {
        ...
        await showPaymentSuccessPopup({
          serviceName: selectedPlan?.name || data?.order?.serviceName || 'Partnership Firm Registration',
  ...
  return (
    <div className="font-sans text-slate-800 bg-white min-h-screen selection:bg-red-100 selection:text-red-900 overflow-x-hidden">
      ...
      <ConsultationPaymentModal
        ...
        title={selectedPlan?.id === 'consultation' ? 'Book Partnership Consultation' : 'Select Partnership Package'}
        initialTermsAccepted={false}
      />

      <div id="partnership-container" className="animate-fade-in">
        {/* 1. Hero Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm text-sm font-bold text-slate-600 mb-6">
                ...
                {sanitizeText(activeHero.badgeText, pageConfig?.city) || 'Indian Partnership Act 1932'}
              </div>
              <h1 className="text-4xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.1] mb-6">
                {sanitizeText(activeHero.title, pageConfig?.city) || 'Register Partnership Firm Online'}
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed mb-8">
                {sanitizeText(activeHero.subtitle, pageConfig?.city) || 'Fast and legally sound partnership firm setup with customized partnership deed drafting.'}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                >
                  Book Legal Call @ ₹{activeHero.consultationPrice || 499} <ArrowRight className="ml-2 w-5 h-5" />
                </button>
            ...
            <div className="lg:w-1/2 relative hidden lg:block">
              <div className="relative z-10 bg-white p-8 rounded-2xl shadow-2xl border border-slate-100 transform rotate-2 hover:rotate-0 transition duration-500">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Partnership Firm Setup</h3>
                    <p className="text-slate-500 text-sm">All-inclusive starting at ₹1,999</p>
                  </div>
                  <div className="bg-green-100 text-green-700 font-bold px-3 py-1 rounded text-xs">ACT 1932</div>
                </div>
                <div className="space-y-4">
                  {['Custom Partnership Deed Drafting', 'State Non-Judicial Stamp Paper', 'Notary Attestation & Execution', 'Firm PAN & TAN Creation', 'Registrar of Firms (ROF) Filing'].map((item, i) => (
        ...
        <div className="bg-slate-900 py-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 mb-6 text-center">
            <p className="text-xs uppercase font-black tracking-widest text-red-400">
              Trusted By Over 5,000+ Fast-Growing Indian Startups & Partnership Firms
            </p>
          </div>
                ...
                >
                  ...
                  <div className="text-4xl font-black text-slate-900 mb-6">
                    ...
                    <span className="text-[10px] font-bold text-slate-500 ml-1 block mt-1">
                      {pkg.isAdjustable ? '(Fully Adjustable)' : '+ Stamp Duty at Actuals'}
                    </span>
                  </div>
        ...
        <section className="py-20 bg-white border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 mt-2 font-medium">Hear directly from partnership firms established through VR Here.</p>
            </div>
        ...
        <section className="py-24 bg-slate-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-20">
              <span className="text-xs uppercase font-black tracking-widest text-red-600 bg-red-50 px-3 py-1.5 rounded-full font-bold">Execution Flow</span>
              <h2 className="text-3xl lg:text-5xl font-black text-slate-900 mt-4 tracking-tight">Redesigned, Effortless Steps</h2>
              <p className="text-lg text-slate-600 mt-2 font-medium">Deed drafting, notary execution, and ROF filing managed by legal experts.</p>
            </div>
        ...
        {/* 6. Why Partnership & Requirements */}
          ...
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed font-medium">
                Partnership firms provide quick setup, flexible profit sharing, and minimal statutory compliance under the Indian Partnership Act, 1932.
              </p>
              <div className="grid grid-cols-1 gap-4">
                {[
                  { t: "Fast Execution", d: "Drafted, notarized, and operational within 3-5 days." },
                  { t: "Flexible Internal Terms", d: "Partners have full autonomy to decide profit ratios, salaries, and capital interest." },
                  { t: "Simple Dissolution", d: "Easy exit and restructuring through a simple Deed of Reconstitution." },
                  { t: "Zero MCA Filing Burden", d: "No annual balance sheet filings with the Ministry of Corporate Affairs." }
                ].map((item, i) => (
            ...
            <div className="md:w-1/2">
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm">
                <h3 className="text-xl font-black text-slate-900 mb-6 text-center">Partnership Minimum Requirements</h3>
                <ul className="space-y-4">
                  {[
                    "Minimum 2 Partners & Maximum 50 Partners",
                    "Airtight Partnership Deed on Stamp Paper",
                    "Firm PAN Card & TAN Application",
                    "Commercial Address Electricity Bill & Landlord NOC",
                    "Optional but recommended Registrar of Firms (ROF) Registration"
                  ].map((req, i) => (
              ...
              <div className="mt-12 text-left bg-slate-50 p-8 md:p-12 rounded-3xl border border-slate-200 animate-in fade-in slide-in-from-top-4 duration-300 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-1 space-y-6 max-h-[500px] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-slate-300">
                  <h3 className="text-xl font-black text-slate-900 border-b-2 border-red-500 pb-2">
                    {activeGuide.title || 'Guide to Partnership Firm Registration'}
                  </h3>
        ...
        <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-slate-400 mb-10 leading-relaxed font-medium">
              Talk to our legal advocates before executing deeds. Pay a small booking fee now, and we will deduct it from your final bill.
            </p>
