...
const LLPRegistrationPage = () => {
  ...
  return (
    <div id="llp-container" className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between font-sans selection:bg-rose-500 selection:text-white">
      {/* 1. Header */}
      <SharedHeader
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-black uppercase tracking-wider">
                  ...
                  <span>{activeHero.badgeText || 'Zero Audit Under ₹40 Lakh Turnover'}</span>
                </div>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                  {activeHero.title || 'Register Your LLP Online in {city}'}
                </h1>
                <p className="text-base sm:text-lg text-slate-300 font-medium max-w-2xl mx-auto lg:mx-0">
                  {activeHero.subtitle || 'The perfect blend of a partnership and private limited company for professionals and partners in {city}, {state}.'}
                </p>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2 text-xs font-semibold text-emerald-400 pt-1">
                  ...
                  <span>Consultation fee of ₹{activeHero.consultationPrice || 499} is 100% adjustable in your final package</span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5">
                <div className="bg-slate-800/80 backdrop-blur-md rounded-3xl p-6 lg:p-8 border border-slate-700/60 shadow-2xl space-y-6">
                  <div className="border-b border-slate-700 pb-4">
                    <h3 className="text-lg font-black text-white">LLP Key Highlights</h3>
                    <p className="text-xs text-slate-400">Limited liability with simplified annual compliances</p>
                  </div>
        ...
        <section className="bg-slate-900 border-y border-slate-800 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">
              Integrated with Top Accounting & Startup Platforms
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
              ...
              <p className="text-sm text-slate-600">
                Choose the best formation package tailored for partners & professionals.
              </p>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-slate-500">In-depth LLP Act guide, eligibility rules, document checklist & FAQs</p>
                </div>
              </div>
