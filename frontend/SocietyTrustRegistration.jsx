...
const SocietyTrustRegistrationPage = () => {
  ...
  return (
    <div id="society-trust-container" className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between font-sans selection:bg-rose-500 selection:text-white">
      {/* 1. Header */}
      <SharedHeader
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-black uppercase tracking-wider">
                  ...
                  <span>{activeHero.badgeText || 'Indian Trusts Act 1882 / Societies Act'}</span>
                </div>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                  {activeHero.title || 'Register Society or Charitable Trust Online in {city}'}
                </h1>
                <p className="text-base sm:text-lg text-slate-300 font-medium max-w-2xl mx-auto lg:mx-0">
                  {activeHero.subtitle || 'Establish your charitable, educational, or religious organization with legal trust deed drafting and government registration in {city}, {state}.'}
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                  ...
                  >
                    <span>Book Trust Advisory @ ₹{activeHero.consultationPrice || 999}</span>
              ...
              <div className="lg:col-span-5">
                <div className="bg-slate-800/80 backdrop-blur-md rounded-3xl p-6 lg:p-8 border border-slate-700/60 shadow-2xl space-y-6">
                  <div className="border-b border-slate-700 pb-4">
                    <h3 className="text-lg font-black text-white">Trust & Society Highlights</h3>
                    <p className="text-xs text-slate-400">Sub-Registrar deed execution & 12A/80G tax exemptions</p>
                  </div>
        ...
        <section className="bg-slate-900 border-y border-slate-800 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">
              Integrated with Leading Donation & Tax Exemption Portals
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
              <div className="inline-block text-rose-600 text-xs font-black uppercase tracking-widest">
                Charitable Formations
              </div>
              <h2 className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight">
                Trust & Society Packages
              </h2>
              <p className="text-sm text-slate-600">
                Choose between Public Charitable Trust, Registered Society, and Full 12A/80G Exemption Suite.
              </p>
            </div>
                  ...
                  <div>
                    ...
                    <div className="bg-slate-50 rounded-2xl p-4 mb-6 border border-slate-100">
                      ...
                      <div className="text-[10px] font-bold text-slate-400 mt-0.5">
                        {pkg.isAdjustable ? '(Fully Adjustable against Package)' : '+ Sub-Registrar / ROF Stamp Duty'}
                      </div>
                    </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-slate-500">Trust vs Society comparative guide, 12A/80G tax exemptions & FAQs</p>
                </div>
              </div>
