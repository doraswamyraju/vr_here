...
const RELATED_SERVICES = [
  {
    ...
    price: "₹6,499",
    desc: "Scale with co-founders, employee ESOPs, and venture investor equity.",
    link: "/pvt-ltd-registration"
  },
  {
    title: "Sole Proprietorship",
    price: "₹1,499",
    desc: "Single owner trade license with Udyam MSME and zero compliance filings.",
    link: "/proprietorship-setup"
  },
  {
    title: "Limited Liability Partnership (LLP)",
    price: "₹7,899",
    desc: "Partner-driven limited liability structure with lower maintenance cost.",
    ...
    launchRazorpayCheckout({
      ...
      onSuccess: async (data) => {
        ...
        await showPaymentSuccessPopup({
          serviceName: selectedPlan?.name || data?.order?.serviceName || 'One Person Company (OPC) Registration',
  ...
  return (
    <div className="font-sans text-slate-800 bg-white min-h-screen selection:bg-red-100 selection:text-red-900 overflow-x-hidden">
      ...
      <ConsultationPaymentModal
        ...
        title={selectedPlan?.id === 'consultation' ? 'Book OPC Consultation' : 'Select OPC Package'}
        initialTermsAccepted={false}
      />

      <div id="opc-container" className="animate-fade-in">
        {/* 1. Hero Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm text-sm font-bold text-slate-600 mb-6">
                ...
                {sanitizeText(activeHero.badgeText, pageConfig?.city) || 'Solo Founder Limited Liability'}
              </div>
              <h1 className="text-4xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.1] mb-6">
                {sanitizeText(activeHero.title, pageConfig?.city) || 'Register One Person Company (OPC) Online'}
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed mb-8">
                {sanitizeText(activeHero.subtitle, pageConfig?.city) || 'Full control for solo founders with corporate status, limited liability, and zero partner dependency.'}
              </p>
            ...
            <div className="lg:w-1/2 relative hidden lg:block">
              <div className="relative z-10 bg-white p-8 rounded-2xl shadow-2xl border border-slate-100 transform rotate-2 hover:rotate-0 transition duration-500">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">OPC Formation Suite</h3>
                    <p className="text-slate-500 text-sm">All-inclusive starting at ₹4,999</p>
                  </div>
                  <div className="bg-green-100 text-green-700 font-bold px-3 py-1 rounded text-xs">SOLO CORPORATE</div>
                </div>
                <div className="space-y-4">
                  {['1 Director Identification Number (DIN)', 'Digital Signature (Class 3 DSC)', 'Form INC-3 Nominee Director Filing', 'SPICe+ MCA Certificate of Incorporation', 'Company PAN, TAN & MSME Certificate'].map((item, i) => (
        ...
        <div className="bg-slate-900 py-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 mb-6 text-center">
            <p className="text-xs uppercase font-black tracking-widest text-red-400">
              Trusted By Over 5,000+ Fast-Growing Indian Startups & Solo Founders
            </p>
          </div>
        ...
        <section className="py-20 bg-white border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl lg:text-5xl font-black text-slate-900 mt-4 tracking-tight">What Solo Founders Say</h2>
              <p className="text-lg text-slate-600 mt-2 font-medium">Hear directly from solo entrepreneurs incorporated with corporate status by VR Here.</p>
            </div>
        ...
        <section className="py-24 bg-slate-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="text-lg text-slate-600 mt-2 font-medium">Solo incorporation with Nominee Director consent filed 100% online.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed font-medium">
                One Person Company allows solo entrepreneurs to enjoy corporate credibility and limited liability without having to share equity with partners.
              </p>
              <div className="grid grid-cols-1 gap-4">
                {[
                  { t: "100% Solo Ownership", d: "Hold 100% equity shares and maintain absolute decision-making autonomy." },
                  { t: "Personal Asset Protection", d: "Personal assets (savings, property) are 100% protected under corporate limited liability." },
                  { t: "Global Enterprise Contracts", d: "International and enterprise clients prefer contracting with registered corporate entities." },
                  { t: "Nominee Succession Clause", d: "Designated nominee director guarantees uninterrupted business continuity." }
                ].map((item, i) => (
            ...
            <div className="md:w-1/2">
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm">
                <h3 className="text-xl font-black text-slate-900 mb-6 text-center">OPC Minimum Requirements</h3>
                <ul className="space-y-4">
                  {[
                    "1 Sole Director & Shareholder (Same person)",
                    "1 Nominee Director (Consent in Form INC-3)",
              ...
              <div className="mt-12 text-left bg-slate-50 p-8 md:p-12 rounded-3xl border border-slate-200 animate-in fade-in slide-in-from-top-4 duration-300 grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-1 space-y-6 max-h-[500px] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-slate-300">
                  <h3 className="text-xl font-black text-slate-900 border-b-2 border-red-500 pb-2">
                    {activeGuide.title || 'Guide to One Person Company Registration'}
                  </h3>
        ...
        <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-slate-400 mb-10 leading-relaxed font-medium">
              Talk to our CA specialists before you commit. Pay a small booking fee now, and we will deduct it from your final bill.
            </p>
